...
import com.farmerhouse.Adapters.ActivitiesRecyclerViewAdapter;
...
public class MandoubActivitiesFragment extends Fragment {
    ...
    public void getActivities(){
        ...
        if(!userId.equals(null) && !userId.equals("")){
            ...
            GsonRequest<MandoubActivity[]> myGsonRequest = new GsonRequest<com.farmerhouse.models.MandoubActivity[]>(Request.Method.POST, url, com.farmerhouse.models.MandoubActivity[].class, null, params,
                    new Response.Listener<com.farmerhouse.models.MandoubActivity[]>() {
                        @Override
                        public void onResponse(com.farmerhouse.models.MandoubActivity[] response) {
