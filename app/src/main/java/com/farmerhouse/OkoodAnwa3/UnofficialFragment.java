package com.farmerhouse.OkoodAnwa3;
...
import com.farmerhouse.Adapters.OfficialAkedRecyclerViewAdapter;
import com.farmerhouse.Adapters.UnOfficialRecyclerViewAdapter;
import com.farmerhouse.FarmerAkedActivity;
import com.farmerhouse.GsonRequest;
import com.farmerhouse.MainActivity;
import com.farmerhouse.MandoobAkedActivity;
...
//        Log.d("url", url.toString());
        ...
        if(!userId.equals(null) && !userId.equals("")){
            ...
            GsonRequest<MandoubAked[]> myGsonRequest = new GsonRequest<com.farmerhouse.models.MandoubAked[]>(Request.Method.POST, url, com.farmerhouse.models.MandoubAked[].class, null, params,
                    new Response.Listener<com.farmerhouse.models.MandoubAked[]>() {
                        @Override
                        public void onResponse(com.farmerhouse.models.MandoubAked[] response) {
