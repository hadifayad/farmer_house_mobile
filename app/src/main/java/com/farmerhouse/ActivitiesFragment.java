...
//        }
    ...
    public void getActivities(){
        ...
        if(!userId.equals(null) && !userId.equals("")){
            ...
            GsonRequest<UserActivity[]> myGsonRequest = new GsonRequest<com.farmerhouse.models.UserActivity[]>(Request.Method.POST, url, com.farmerhouse.models.UserActivity[].class, null, params,
                    new Response.Listener<com.farmerhouse.models.UserActivity[]>() {
                        @Override
                        public void onResponse(com.farmerhouse.models.UserActivity[] response) {
