...
public class MandoubActivitiesRecyclerViewAdapter extends RecyclerView.Adapter<com.farmerhouse.Adapters.MandoubActivitiesRecyclerViewAdapter.MyViewHolder> {
    ...
    @Override
    public com.farmerhouse.Adapters.MandoubActivitiesRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup
                                                                                                          parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mandoub_activity_item, parent, false);
        context = parent.getContext();
        return new com.farmerhouse.Adapters.MandoubActivitiesRecyclerViewAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final com.farmerhouse.Adapters.MandoubActivitiesRecyclerViewAdapter.MyViewHolder holder, final int position) {
