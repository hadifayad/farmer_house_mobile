...
//        params.put("parentId", data.getId());
        GsonRequest<Plant[]> myGsonRequest = new GsonRequest<com.uzarsif.models.Plant[]>(Request.Method.POST, url, Plant[].class, null, params,
                new Response.Listener<com.uzarsif.models.Plant[]>() {
                    @Override
