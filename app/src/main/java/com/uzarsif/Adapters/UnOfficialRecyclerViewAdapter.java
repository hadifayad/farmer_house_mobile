...
public class UnOfficialRecyclerViewAdapter extends RecyclerView.Adapter<com.uzarsif.Adapters.UnOfficialRecyclerViewAdapter.MyViewHolder> {
    ...
    @Override
    public com.uzarsif.Adapters.UnOfficialRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup
                                                                                                            parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mandoub_aked_item, parent, false);
        context = parent.getContext();
        return new com.uzarsif.Adapters.UnOfficialRecyclerViewAdapter.MyViewHolder(itemView);
    }
