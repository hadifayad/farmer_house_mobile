...
import com.uzarsif.ViewAkedActivity;
import com.uzarsif.models.MandoubAked;

import java.util.List;

public class OfficialAkedRecyclerViewAdapter extends RecyclerView.Adapter<com.uzarsif.Adapters.OfficialAkedRecyclerViewAdapter.MyViewHolder> {
    ...
    @Override
    public com.uzarsif.Adapters.OfficialAkedRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup
                                                                                                                 parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mandoub_aked_item, parent, false);
        context = parent.getContext();
        return new com.uzarsif.Adapters.OfficialAkedRecyclerViewAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final com.uzarsif.Adapters.OfficialAkedRecyclerViewAdapter.MyViewHolder holder, final int position) {
