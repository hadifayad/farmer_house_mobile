...
public class ActivitiesRecyclerViewAdapter extends RecyclerView.Adapter<com.uzarsif.Adapters.ActivitiesRecyclerViewAdapter.MyViewHolder> {
        ...
        @Override
        public com.uzarsif.Adapters.ActivitiesRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup
        parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.activity_item, parent, false);
            context = parent.getContext();
            return new com.uzarsif.Adapters.ActivitiesRecyclerViewAdapter.MyViewHolder(itemView);
        }


        @Override
        public void onBindViewHolder(final com.uzarsif.Adapters.ActivitiesRecyclerViewAdapter.MyViewHolder holder, final int position) {
