        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(ChatCommentsActivity.this);
...
//                                        Toast.makeText(ChatCommentsActivity.this, "حدث ", Toast.LENGTH_LONG).show();
...
//                        dialog.dismiss();
                        commentsRecyclerViewAdapter = new CommentsRecyclerViewAdapter(new ArrayList<>(Arrays.asList(response)));
